...
const posiblesRutas = [
  ...
  'C:\\Users\\etigr\\Downloads\\samy-app\\serviceAccountKey.json',
...
const SALTAR_PRIMEROS = 39600  // CAMBIAR AQUÍ: continuar desde donde paró
const BATCH_SIZE = 100  // Reducido de 500 a 100 (más pequeño = más rápido)
const DELAY_MS = 500   // Espera entre batches en milisegundos
// ────────────────────────────────────────────────────────
...
async function importar() {
  ...
  console.log(`🚀 Subiendo ${pendientes.length} registros (batch ${BATCH_SIZE}, delay ${DELAY_MS}ms)...\n`)
  ...
  for (let i = 0; i < pendientes.length; i += BATCH_SIZE) {
    try {
      ...
      console.log(`\n📊 Progreso guardado: ${subidos}/${total} registros`)
