  ...
  root.innerHTML = `
    ...
    ">
      <div style="
        ...
        max-width: 400px;
      ">
        <h1 style="text-align: center; margin-bottom: 30px; color: #1e3a8a; font-size: 24px;">
          📊 Mesarios
        </h1>
        <h2 style="text-align: center; margin-bottom: 30px; color: #666; font-size: 16px; font-weight: 400;">
          Login - Samy 2026
        </h2>
